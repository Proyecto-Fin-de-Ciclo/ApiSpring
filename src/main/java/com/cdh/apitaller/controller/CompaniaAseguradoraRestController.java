...
@Slf4j
public class CompaniaAseguradoraRestController implements GenericController<CompaniaAseguradora, CompaniaAseguradoraDTO>{
    ...
    @Override
    public ResponseEntity<String> post(@RequestBody CompaniaAseguradoraDTO companiaAseguradoraDTO) throws ParseException {
    log.info("Creando compañia aseguradora");
        companiaAseguradoraService.add(companiaAseguradoraDTO);
        return ResponseEntity.ok("Compañia aseguradora creada correctamente");
    }
    ...
    @Override
    public ResponseEntity<String> put(@RequestBody CompaniaAseguradoraDTO S) throws ParseException {
    log.info("Actualizando compañia aseguradora");
        companiaAseguradoraService.update(S);
        return ResponseEntity.ok("Compañia aseguradora actualizada correctamente");
    }
